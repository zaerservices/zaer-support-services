                            ...
                            <div className="col-lg-12 mx-auto">
                                <div className="row">
                                    ...
                                    <div className="col-lg-8">
                                        <div className="single-detail"><img className="img-responsive bdr-16" src="assets/imgs/template/terms_of_service.jpg" alt="terms-service" />
                                            <h6 className="mt-35 mb-25" id="section-1">Terms and services</h6>
                                            <p>
This website is operated by Zaer Support Services offer disability support Services. Throughout the site, the terms “we”, “us” and “our” refer to Zaer Support Services. Zaer Support Services offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
Questions about the Terms of Service should be sent to us at zaer.services@gmail.com 
